              ...
              <div className="px-6 py-4 bg-gray-50">
                <div className="flex justify-center">
                  <button
                    ...
                    className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium py-2 px-8 rounded-full transition-all duration-300"
                  >
                    Entendido, continuar
                  </button>
                </div>
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0">
                  ...
                  <div className="flex space-x-3">
                    ...
                    <button
                      ...
                      className="bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-medium py-2 px-6 rounded-full transition-all duration-300"
                    >
                      Acepto los Términos
                    </button>
                  </div>
