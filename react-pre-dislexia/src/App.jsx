...
import DiagnosticoProvider from "./context/context";
import PreReporte from "./Pages/Pruebas/PreReporte";
    ...
    <DiagnosticoProvider>
      <Router>
        ...
        <Routes>
          ...
          <Route
            exact
            path="/evaluacion/registro"
            element={<Registro />}
          ></Route>
          <Route path="/evaluacion/pre-inicio" element={<PreInicio />} />

          <Route
            path="/evaluacion/palabra-imagen"
            element={<PalabraImagen />}
          />
          <Route
            path="/evaluacion/completa-palabra"
            element={<CompletaPalabra />}
          />
          <Route
            path="/evaluacion/patron-figuras"
            element={<PatronFiguras />}
          />
          <Route
            path="/evaluacion/cuestionario-padres"
            element={<CuestionarioPadres />}
          />

          <Route
            path="/evaluacion/pre-reporte"
            element={<PreReporte/>}
          />
